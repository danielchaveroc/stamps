      ...
      <div className={styles.keystrokesContainer}>
        <div className={styles.inlineContainer}>
          ...
          <div className={styles.simpleContainer}>
            <div className={styles.inlineContainer}>
              <div className={styles.largerTitle}>FREE MINT ONLY FOR HOLDERS</div>
            </div>
            <div className={styles.inlineContainer}>
              <div className={styles.largerTitle}>by <b><i>Custodios</i></b></div>
            </div>
            <div className={`${styles.inlineContainer} ${styles.divAsLink}`} onClick={()=> window.open("https://www.custodios.io/", "_blank")}>
